...
func admin(g *gin.RouterGroup) {
	...
	setting.POST("/set_115", handles.Set115)
        ...
        automationGroup.GET("/list", handles.ListAutomationTasks)
        automationGroup.POST("/create", handles.CreateAutomationTask)
        automationGroup.POST("/update", handles.UpdateAutomationTask)
        automationGroup.POST("/delete", handles.DeleteAutomationTask)
        automationGroup.POST("/toggle", handles.ToggleAutomationTask)
        automationGroup.POST("/run", handles.RunAutomationTask)
        automationGroup.GET("/history", handles.AutomationHistory)
