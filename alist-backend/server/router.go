...
func Init(e *gin.Engine) {
	...
	auth.GET("/notification/enabled", handles.ListEnabledNotifications)
...
func admin(g *gin.RouterGroup) {
	...
	notification := g.Group("/notification")
	notification.GET("/list", handles.ListNotifications)
	notification.GET("/get", handles.GetNotification)
	notification.POST("/create", handles.CreateNotification)
	notification.POST("/update", handles.UpdateNotification)
	notification.POST("/delete", handles.DeleteNotification)
	notification.POST("/test", handles.TestNotification)
